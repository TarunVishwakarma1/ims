...
func TestPlace_Razorpay_NotGatedByCODBounds(t *testing.T) {
	...
	svc := shop.NewCheckoutService(pool, orgID, cartRepo, repository.NewCustomerAddressRepository(pool), stubPayment, testdb.OrderRepo(pool), nil, "test_key_id", 10000, 500000, 300, 0, 0)
