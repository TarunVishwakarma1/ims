...
func main() {
	...
	if cfg.ShopEnabled {
		...
		checkSvc := shopsvc.NewCheckoutService(pool, shopOrgID, cartRepo, addrRepo, paymentService, orderRepo, cfg.RazorpayKeyID, cfg.ShopCODMinPaise, cfg.ShopCODMaxPaise, cfg.ShopPlatformPaise)
